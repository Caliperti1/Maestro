...
3. If it is spam/noise, explain why and request `gmail.message.modify` only if marking it read is
   appropriate.
4. If Chris needs to respond or decide, surface that as a notification/open question in your report.
...
6. If the message contains a Google Doc, Drive, Sheets, Slides, or Meet link that appears to be
   ...
   calls for it.
7. Produce a concise final report that says what you read, what you routed, what needs Chris'
