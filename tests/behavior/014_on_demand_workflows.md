...
- Personal, Maestro Development, USMA, L3, Perti Laboratories, and Praxis domains contain enough current
...
| 14.3 | Open the active run. | Personal, Maestro Development, USMA, L3, Perti, and Praxis input items are Stage 1 and can run in parallel. Standup synthesis is Stage 2 and waits for all six reports. | Workflow map and queue-item detail. | Not run |
